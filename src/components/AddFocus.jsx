...
const AddFocus = ({setFocus}) => {
  ...
  const handleMouseDownPassword = (event) => {
    ...
    <InputLabel htmlFor="standard-adornment-password">What do you want to focus on?</InputLabel>
    <Input
    ...
    <NavLink to="/distractions" className="nav-link">
    <span>Add Focus</span>
    </NavLink>
    </Button>
    </Box>
